...
public class LoginController {
    ...
    public LoginController(LoginView vista) {
        ...
        this.vista.botonIngresar.addActionListener((ActionEvent e) -> {
            ...
            Usuario user = null;
            if (usuario.equals("will") && contrasena.equals("123")) {
    ...
    private void abrirMenu(@SuppressWarnings("unused") Usuario usuario) {
        ...
        new ReservaController(reservaView, new HabitacionController(habitacionView));
